var GalleryDialog = {
	preInit : function() {
		...
		tinyMCEPopup.resizeToInnerSize();
                ...
                var li = jQuery(n).parents("ul.TINYMCE_gallery").children("li");
                ...
                if (jQuery(n).parents("ul.TINYMCE_gallery").length) { //its an edit
                    ...
                    jQuery(li).each(function(){
                        ...
                        //jQuery("#gallery_form div.image_wrapper:first").empty();
                  ...
                  //  console.log( jQuery(n).parents("ul.TINYMCE_gallery").find("a"))

                    var border = jQuery(n).parents("ul.TINYMCE_gallery").find("a").css("borderColor");
			...
			ed.dom.setAttribs(el, args);
                   ...
                   var list="";
                    jQuery("input[name=src\[\]]").each(function(){
                       ...
                       var replace300Regex = new RegExp(/-300x[0-9]+/)
                    ...
                    var wrapper = jQuery("<div> </div>")
                       ...
                       if (jQuery("#is_edit").val()==0) {
                        ...
                        //console.log(jQuery(wrapper).html())
